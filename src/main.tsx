...
ReactDOM.createRoot(document.getElementById('root')!).render(
  <React.StrictMode>
    ...
    <img className='bird um' src="https://www.salesforce.com/content/dam/web/en_us/www/images/marketing-cloud/overview/mc-bird.png"></img>
    <div className="album">
      <a href='#'><Card image= 'https://colaninfotech.com/wp-content/uploads/2023/02/crmblock.jpg'
      product="CRM"
      description="CRM é a sigla usada para Customer Relationship Management e se refere ao conjunto de práticas,
      estratégias de negócio e tecnologias focadas no relacionamento com o cliente."/></a>
      
      <a href='#'><Card image="https://cynoteck.com/wp-content/uploads/2022/06/Salesforce-Marketing-Cloud-min.png"
      product="Marketing Cloud"
      description='Atraia clientes. Gere mais engajamento.
      Construa relações duradouras.
      Tudo isso graças ao marketing digital baseado em dados.'/></a>
